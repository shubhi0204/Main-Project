...
const sendEmail = require("../utils/sendEmail"); // Importing the sendEmail function
const { isAuthenticatedUser, authorizeRoles } = require("../middleware/auth");
const router = express.Router();

router.route("/register").post(registerUser);
router.route("/login").post(loginUser);
router.route("/password/forgot").post(forgetPassword); // Assuming this route is for handling forgot password requests
